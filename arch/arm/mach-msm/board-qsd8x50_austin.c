...
#define SLOT1_CARD_DETECT_GPIO 39
#define SLOT3_CARD_DETECT_GPIO 158
#else
...
static struct usb_composition usb_func_composition[] = {
    {
        ...
        .functions      = 0x12,
        .adb_product_id     = 0xB007,
        .adb_functions      = 0x12,
        .diag_product_id     = 0xB007,
...
static uint32_t camera_on_gpio_surf_table[] = {
    GPIO_CFG(2,  0, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_2MA), 
    GPIO_CFG(3,  0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), 
    GPIO_CFG(104, 0, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_2MA), 
};

static uint32_t camera_off_gpio_surf_table[] = {
	GPIO_CFG(2,  0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), 
	GPIO_CFG(3,  0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), 
