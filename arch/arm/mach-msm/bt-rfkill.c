...
static unsigned bt_config_power_on[] = {
	GPIO_CFG(139, 1, GPIO_INPUT, 		GPIO_PULL_DOWN, 	GPIO_2MA),	
	GPIO_CFG(140, 1, GPIO_OUTPUT,  	GPIO_NO_PULL, 		GPIO_2MA),	
	GPIO_CFG(141, 1, GPIO_INPUT,  	GPIO_PULL_DOWN, 	GPIO_2MA),	
	GPIO_CFG(157, 1, GPIO_OUTPUT, 	GPIO_NO_PULL, 		GPIO_2MA),	
};
static unsigned bt_config_power_off[] = {
	GPIO_CFG(139, 0, GPIO_INPUT, 	GPIO_PULL_UP, 		GPIO_2MA),	
	GPIO_CFG(140, 0, GPIO_INPUT,  GPIO_PULL_DOWN, 	GPIO_2MA),	
	GPIO_CFG(141, 0, GPIO_INPUT,  GPIO_PULL_DOWN, 	GPIO_2MA),	
	GPIO_CFG(157, 0, GPIO_INPUT,	GPIO_PULL_DOWN, 	GPIO_2MA),	
};
