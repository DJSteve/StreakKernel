...
struct yaffs_DeviceParamStruct {
	...
	int disableSoftDelete;  
	
	int deferDirectoryUpdate; 

#ifdef CONFIG_YAFFS_AUTO_UNICODE
	int autoUnicode;
#endif
	int alwaysCheckErased; 
};
...
struct yaffs_DeviceStruct {
	...
	unsigned hasPendingPrioritisedGCs; 
	unsigned gcDisable;
	...
	struct ylist_head dirtyDirectories; 
