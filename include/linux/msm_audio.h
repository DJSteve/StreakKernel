...
#define QISDA_HANDSET_LOOKBACK				0xFB	
#define QISDA_HEADSET_LOOKBACK				0xFC	
#define QISDA_LOUDSPEAKER_LOOKBACK			0xFD	
#define QISDA_HANDSET_LOOKBACK_START		0xFE
#define QISDA_HANDSET_LOOKBACK_STOP			0xFF
