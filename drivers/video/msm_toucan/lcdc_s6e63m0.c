...
static int lcdc_s6e63m0_gpio_setup(void)
{
	...
	{
		gpio_tlmm_config(GPIO_CFG(gpio_num, 1, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
	}	
	gpio_tlmm_config(GPIO_CFG(135, 1, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_4MA), GPIO_ENABLE);
	gpio_tlmm_config(GPIO_CFG(136, 1, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
	gpio_tlmm_config(GPIO_CFG(137, 1, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_4MA), GPIO_ENABLE);
	gpio_tlmm_config(GPIO_CFG(138, 1, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_4MA), GPIO_ENABLE);
...
lcdc_s6e63m0_spi_read_err_spi_sync:
	...
	gpio_tlmm_config(GPIO_CFG(18, 0, GPIO_OUTPUT,  GPIO_NO_PULL, GPIO_2MA), GPIO_ENABLE);	
...
static int __init lcdc_s6e63m0_init(void)
{
	int ret = 0;
