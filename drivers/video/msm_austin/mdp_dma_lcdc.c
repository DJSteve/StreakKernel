...
#endif
extern int current_hdmi_timing;

int first_pixel_start_x;
int first_pixel_start_y;

extern atomic_t hdmi_audio_only_flag;
...
int mdp_lcdc_on(struct platform_device *pdev)
{
	...
	if(unlikely(atomic_read(&hdmi_audio_only_flag)))
	{
		printk(KERN_ERR "### hdmi_audio_only_flag is TRUE\n");
	}
	else
	{
