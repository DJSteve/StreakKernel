...
int16 BCMROMFN(qm_sat32)(int32 op);

int32 BCMROMFN(qm_mul321616)(int16 op1, int16 op2);
...
int32 BCMROMFN(qm_mul323216)(int32 op1, int16 op2);

int32 BCMROMFN(qm_mulsu321616)(int16 op1, uint16 op2);
