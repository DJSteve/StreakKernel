...
#if defined(BCMPERFSTATS) || defined(UNDER_CE)
#include <bcmperf.h>
#endif
...
void
BCMROMFN(pktq_pflush)(osl_t *osh, struct pktq *pq, int prec, bool dir)
{
	struct pktq_prec *q;
	void *p;
...
void
BCMROMFN(pktq_flush)(osl_t *osh, struct pktq *pq, bool dir)
{
	int prec;
...
#if  !defined(BCMROMOFFLOAD) || defined(BCMROMREV2)
...
STATIC const uint8 BCMROMDATA(crc8_table)[256] = {
...
STATIC const uint32 BCMROMDATA(crc32_table)[256] = {
