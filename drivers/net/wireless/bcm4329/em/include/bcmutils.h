...
extern void *BCMROMFN(pktq_penq)(struct pktq *pq, int prec, void *p);
extern void *BCMROMFN(pktq_penq_head)(struct pktq *pq, int prec, void *p);
extern void *BCMROMFN(pktq_pdeq)(struct pktq *pq, int prec);
extern void *BCMROMFN(pktq_pdeq_tail)(struct pktq *pq, int prec);

extern bool BCMROMFN(pktq_pdel)(struct pktq *pq, void *p, int prec);


extern void BCMROMFN(pktq_pflush)(osl_t *osh, struct pktq *pq, int prec, bool dir);

extern void BCMROMFN(pktq_flush)(osl_t *osh, struct pktq *pq, bool dir);



extern int BCMROMFN(pktq_mlen)(struct pktq *pq, uint prec_bmp);
extern void *BCMROMFN(pktq_mdeq)(struct pktq *pq, uint prec_bmp, int *prec_out);
...
extern void BCMROMFN(pktq_init)(struct pktq *pq, int num_prec, int max_len);

extern void *BCMROMFN(pktq_deq)(struct pktq *pq, int *prec_out);
extern void *BCMROMFN(pktq_deq_tail)(struct pktq *pq, int *prec_out);
extern void *BCMROMFN(pktq_peek)(struct pktq *pq, int *prec_out);
extern void *BCMROMFN(pktq_peek_tail)(struct pktq *pq, int *prec_out);



extern uint BCMROMFN(pktcopy)(osl_t *osh, void *p, uint offset, int len, uchar *buf);
extern uint pktfrombuf(osl_t *osh, void *p, uint offset, int len, uchar *buf);
extern uint BCMROMFN(pkttotlen)(osl_t *osh, void *p);
extern void *BCMROMFN(pktlast)(osl_t *osh, void *p);
extern uint BCMROMFN(pktsegcnt)(osl_t *osh, void *p);


extern uint BCMROMFN(pktsetprio)(void *pkt, bool update_vtag);
...
extern char *BCMROMFN(getvar)(char *vars, const char *name);
...
extern int BCMROMFN(bcm_iovar_lencheck)(const bcm_iovar_t *table, void *arg, int len, bool set);
...
#if defined(BCMDBG) || defined(DHD_DEBUG) || defined(WLMSG_PRHDRS) || \
	defined(WLMSG_PRPKT) || defined(WLMSG_ASSOC)
