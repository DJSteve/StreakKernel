...
MODULE_DESCRIPTION("L-sensor driver");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:lsensor");
...
static int __init qsd_lsensor_init(void)
{
  ...
  gpio_tlmm_config(GPIO_CFG(ALS_GPIO_SD,0,GPIO_OUTPUT,GPIO_NO_PULL,GPIO_2MA),GPIO_ENABLE);
