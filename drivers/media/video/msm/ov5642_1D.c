...
static long ov5642_1D_preview_transform(enum ov5642_white_balance_t wb)
{
    ...
    if( MANUAL_TRANSFORM == ov5642_1D_transform_flag )
    {
        ...
        if( exposure > 0x3000 )
        {
            ov5642_1D_transform_reg[EXPOSURE_HIGH].data = 0x00;
            ov5642_1D_transform_reg[EXPOSURE_MID].data = 0x20;
            ov5642_1D_transform_reg[EXPOSURE_LOW].data = 0x00;
            CDBG("ov5642_1D_preview_transform: limited to 0x2000\n");
        }
...
#define  PREVIEW_FRAMERATE 2000 
    ...
    memcpy(ov5642_1D_transform_reg,
           ...
           sizeof(ov5642_1D_transform_reg)-sizeof(ov5642_1D_transform_reg[LIGHT_INDICATOR]));
