...
static void msm_hs_stop_rx_locked(struct uart_port *uport)
{
	...
	BT_DEBUG("msm_uport->rx.flush = %d", msm_uport->rx.flush);
...
static void msm_hs_shutdown(struct uart_port *uport)
{
	...
	printk(KERN_INFO "msm_hs_shutdown wait for rx flush msm_uport->rx.flush = %d\n", msm_uport->rx.flush);
	wait_event(msm_uport->rx.wait, msm_uport->rx.flush == FLUSH_SHUTDOWN);
	printk(KERN_INFO "msm_hs_shutdown wait for rx flush done\n" );
